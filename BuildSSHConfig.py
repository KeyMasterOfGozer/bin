...
if os.path.isfile(HomeFolder+'/.ssh/known_hosts'):
	with open(HomeFolder+'/.ssh/known_hosts','r') as f:
	...
	with open(HomeFolder+'/.ssh/known_hosts','w') as f:
	...
	with open(HomeFolder+'/.ssh/known_hosts.old','w') as f:
